	...
	/**
	 * Movimientos que va a manejar la estructura. Son de conocimiento pblico,
	 * pero slo deberan usarse para el manejo puntual de esta estructura.
	 */
	typedef enum
	{
		L_Primero,
	 ...
	 * ningn concepto en la aplicacin.
	 */
